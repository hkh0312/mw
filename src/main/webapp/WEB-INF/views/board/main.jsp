               ...
               <div class="row">
                  ...
                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              <li class="nav-item active">
                                 <a class="nav-link" href="/board/main">Home</a>
                              </li>
                              <li class="nav-item">
                        ...
                        <ul class="search">
                           <li><a href="/member/login"><i class="fa fa-user" aria-hidden="true">Login</i></a></li>
                        </ul>
                     </nav>
                  </div>
               </div>
               ...
               <div class="col-sm-12">
                  <div class="ru_bg">
                     <div class="row">
                        ...
                        <div class="col-md-9">
                           <ul class="lacation">
                              <li><i class="fa fa-map-marker" aria-hidden="true"></i> Gb road 123 london Uk </li>
                              <li><i class="fa fa-volume-control-phone" aria-hidden="true"></i> G(+01) 123456789012</li>
                              <li><i class="fa fa-envelope" aria-hidden="true"></i> demo@gmail.com</li>
                           </ul>
                        </div>
                     </div>
                  </div>
