...
<script>
	$(document).ready(function() {
		...
		$("#addQnA").click(function(e) {
			...
			if (hiddenVal == 1) {			
				var cloneQnA = $("#updateQnA").clone();
				console.log(cloneQnA);
				cloneQnA.find("input").val("");
				cloneQnA.find("input").attr("name", "arr_ques");
				cloneQnA.find("textarea").val("");
				cloneQnA.find("textarea").attr("name", "arr_answers");
				$("#attachQnA").append(cloneQnA);
				cloneQnA.show(500);
			} else if (hiddenVal == 0) {
...
<div class="blog">
	<div class="container ">
		<form role="form" action="/create/insertRun" method="post"
			enctype="multipart/form-data">
			<input type="hidden" id="hidden" name="insertType" value="1">
							...
							<div class="col-md-6 befold" data-state="0">
								<div class="marriage_text">
									...
									<h4>
										...
										<a href="/create/search?clientId=lee"><strong
											class="padd_right right_float">미리보기</strong></a>
									</h4>
								</div>
							</div>
										...
										<c:when test="${map.qnaVo != null }">
											<c:forEach var="qnaVo" items="${map.qnaVo }"
												...
												<div id="updateQnA" class="updateQnA"style="text-align: right">
													<a class="col-md-12" href="#"> <i class="fa fa-trash-o"
														aria-hidden="true">삭제</i>
													</a>
													<div class="form-group" style="display: none">
														<div class="col-md-12">
															<input type="text" class="form-control" name="qno"
																placeholder="질문(50자이내)" value="${qnaVo.qno }">
														</div>
													</div>
													<div class="form-group">
														<div class="col-md-12">
															<input type="text" class="form-control" name="update_ques"
