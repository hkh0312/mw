            ...
            <div class="row mt-5">
                <div class="col-lg-5 col-md-6 align-self-center py-5">
                    ...
                    <div class="dishes-text">
                        <h3><span>${map.storyVo.story_one_title }</span></h3>
                        <p class="pt-3">${map.storyVo.story_one_con }</p>                                             
                    </div>
                </div>
                <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center mt-4 mt-md-0">
                    <img src="/create/displayImg?pic=${map.storyVo.story_one_pic }" alt="" class="img-fluid shadow w-100">
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-lg-5 col-md-6 align-self-center order-2 order-md-1 mt-4 mt-md-0">
                    <img src="/create/displayImg?pic=${map.storyVo.story_two_pic }" alt="" class="img-fluid shadow w-100">
                </div>
                <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center order-1 order-md-2 py-5">
                    <h2 class="special-number">02.</h2>
                    <div class="dishes-text">
                        <h3><span>${map.storyVo.story_two_title }</span></h3>
