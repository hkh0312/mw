				...
				<div class="container">
					<div class="row">
						<div class="col-xs-12 text-right menu-1">
							<ul>
								<li id="ctgHome"><a href="/preview/h_home">Home</a></li>
								<li id="ctgOurstory"><a href="/preview/h_ourstory">Our Story</a></li>
								<li id="ctgPhotos"><a href="/preview/h_photos">Photos</a></li>
								<li id="ctgQna"><a href="/preview/h_qna">Q + A</a></li>
								<li id="ctgTravel"><a href="/preview/h_travel">Travel</a></li>
								<li id="ctgMessages"><a href="/preview/h_messages">Messages</a></li>
							</ul>
						</div>
					</div>
